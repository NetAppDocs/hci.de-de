...
Wenn Sie ein In-Place-Upgrade eines bestehenden Management-Knotens auf Element 12.8 oder höher durchführen, müssen Sie vor dem Upgrade sicherstellen, dass die VM-Hardwareversion auf dem Management-Knoten mit ESXi 6.7 (VM-Hardwareversion 14) oder höher kompatibel ist, abhängig von Ihrer Umgebung.
