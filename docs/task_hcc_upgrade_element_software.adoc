...
[]
====
Das Management Services 2.27-Paket enthält das Element Plug-in für vCenter Server 5.5, das nur mit dem Management Node 12.8 kompatibel ist.  Wenn Sie auf Management Services 2.27 aktualisieren, müssen Sie die Upgrade-Reihenfolge ändern und das Management Services-Paket nach dem Upgrade auf Element 12.8 aktualisieren, um die Kompatibilität zwischen dem Management-Knoten und den Management Services sicherzustellen.

Wenn Sie auf die Verwaltungsdienste 2.21.61 bis 2.26.40 aktualisieren, müssen Sie das Verwaltungsdienstpaket aktualisieren, bevor Sie auf Element 12.8 aktualisieren.
