...
[[upgrade-firmware-on-h410c-and-h300eh500eh700e-nodes]]
=== Firmware-Upgrade auf den Nodes H410C und H300E/H500E/H700E
...
[[upgrade-firmware-on-h610ch615c-nodes]]
=== Firmware auf H610C/H615C Nodes aktualisieren
...
* link:https://kb.netapp.com/on-prem/solidfire/Element_OS_Kbs/vmnic1_and_vmnic4_is_swapped_by_compute_node_firmware_upgrade["Firmware-Upgrade des Compute-Knotens vertauscht vmnic1 und vmnic4"^]
* link:https://docs.netapp.com/us-en/vcp/index.html["NetApp Element Plug-in für vCenter Server"^]
